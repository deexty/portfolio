...
export default function LastProject() {
  ...
  return (
    <section
      data-aos="fade-up"
      className="flex flex-col items-center justify-center min-h-screen bg-lastProject-vetor bg-no-repeat bg-center px-5 md:px-10 mb-20 md:mb-0 mt-20 md:mt-0"
    >
      ...
      {projetos[projetos.length - 1] && (
        <div
          className="flex flex-col md:flex-row flex-nowrap items-center mt-10 w-full md:w-7/12 "
          data-aos="fade-up"
        >
          <div className="w-full md:w-2/5 flex flex-col justify-between items-start order-2 md:order-1">
            ...
            <div>
              ...
              <ul className="flex flex-wrap justify-end md:justify-start mb-6">
          ...
          <img src={`${import.meta.env.VITE_API_URL}/imagem/${projetos[projetos.length - 1].imagem}`} className="inline-block w-full mb-6 md:mb-0 md:w-3/5 h-48 mt-10 sm:mt-0 sm:h-72 bg-white md:ml-10 order-1 md:order-2"></img>
        </div>
      )}
    </section>
  );
